...
public class IncidenteJpaController implements Serializable {
    ...
    public void create(Incidente incidente) throws PreexistingEntityException, Exception {
        ...
        try {
            ...
            if (findIncidente(incidente.getId()) != null) {
                throw new PreexistingEntityException("Incidente " + incidente + " already exists.", ex);
            }
            throw ex;
        } finally {
            if (em != null) {
